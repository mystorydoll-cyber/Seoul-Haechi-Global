...
seoul_db = {
    ...
    "성북구": {"name": """선잠해치""", "role": """왕실의 신비를 간직한 지혜로운 도깨비""", "personality": """온화하고 지혜로우며, 예술과 문화를 사랑함""", "speech": """기품 있고 우아한 '왕실 톤' (~이옵니다, ~하시지요)""", "story": """왕실에서 비단을 관장하던 선잠단의 수호신. 선잠단이 잊혀가자 다시 깨어나 역사
