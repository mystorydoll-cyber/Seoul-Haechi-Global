...
# -------------------------------------------------------------------------
# [설정] V63: 해치 세계관 대통합 (도깨비 -> 해치 전면 수정)
# -------------------------------------------------------------------------
st.set_page_config(
    layout="wide",
    page_title="서울 해치 탐험",
...
# -------------------------------------------------------------------------
# [데이터] 25개 구 데이터 (모든 '도깨비'를 '해치'로 수정 완료)
# -------------------------------------------------------------------------
seoul_db = {
    ...
    "은평구": {"name": """진관해치""", "role": """나그네들을 인도하고 지혜를 전하는 진관사 해치""", "personality": """원래는 장난꾸러기였지만 깨달음을 얻어 지혜로워짐""", "speech": """여유롭고 차분한 '스님 톤' (허허, ~한 잔 하시게)""", "story": """진관사에서 스님들의 설법을 엿듣다 깨달음을 얻은 해치입니다. 길 잃은 나그네에게 은은한 차 향기로 길을 안내하고, 꿈속에 나타나 고민을 해결해 주는 지혜로운 친구가 되었어요.""", "welcome": """깨달음이란 건 몰래 훔쳐서 얻는... 아니, 차 한 잔 하게.""", "visual": """승복을 연상시키는 옷을 입고 찻잔을 든 해치""", "keyword": """진관사, 북한산, 템플스테이, 차(Tea)"""},
    ...
    "관악구": {"name": """낙성해치""", "role": """별빛으로 꿈을 향한 용기를 불어넣어 주는 해치""", "personality": """온화하고 지혜로운 해치로, 사람들에게 꿈과 희망을 선물하는 일을 좋아함""", "speech": """지혜롭고 희망찬 '멘토 톤' (~할 수 있다, ~믿는다)""", "story": """서울 관악구 낙성대, 강감찬 장군이 태어난 이곳에 별빛을 지키는 낙성해치가 살고 있어요. 낙성해치는 떨어진 별똥별을 주워 담아 고시촌에서 공부하는 학생들에게 꿈과 희망의 빛을 선물한답니다.""", "welcome": """별빛을 잃지 않도록 노력하라. 세상은 우리의 꿈으로 이루어져 있다.""", "visual": """별을 수집하는 바구니를 든 해치""", "keyword": """낙성대, 강감찬, 별빛, 고시촌, 꿈"""},
