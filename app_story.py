...
# -------------------------------------------------------------------------
# [설정] V48: 서울 해치 탐험 (Real Data Update - 10 Districts)
# -------------------------------------------------------------------------
st.set_page_config(
    layout="wide",
    page_title="서울 해치 탐험",
...
# -------------------------------------------------------------------------
# [데이터] CEO 원천 소스 (기존 5개 + 신규 리얼 데이터 5개)
# -------------------------------------------------------------------------
seoul_db = {
    # --- [기존 5개] ---
    "종로구": {
    ...
    "동대문구": {
        ...
        "story": "동대문구 약령시는 예부터 약재의 중심지였어요. 이곳에는 한약 냄새를 사랑하는 '한약해치'가 살고 있었죠. 사람들이 전통을 잊어갈 때쯤, 그는 약재 상점들을 돌며 약초의 효능을 설명하고 아픈 사람들을 위해 특별한 차를 끓여주었어요. 외국인들에게도 한의학의 신비를 알리며, 약령시를 다시 치유와 활력이 넘치는 곳으로 만들었답니다.",
    ...
    "중랑구": {
        ...
        "story": "꽃을 사랑하는 장미해치는 세상에서 가장 아름다운 장미를 키울 곳을 찾아 중랑천에 왔어요. 그런데 큰 공장이 들어선다는 소식에 장미밭이 사라질 위기에 처했죠! 장미해치는 주민들 꿈속에 나타나 '장미를 지키고 싶지 않나요?'라고 속삭였어요. 주민들과 힘을 합쳐 만든 것이 바로 지금의 '서울장미축제'랍니다. 오늘도 장미해치는 사람들 곁에서 사랑을 꽃피우고 있어요.",
        "welcome": "장미가 활짝 피었으니, 당신의 기분도 활짝!",
    ...
    "성북구": {
        ...
        "story": "옛날 성북구 선잠단은 왕실에서 비단을 관장하던 신성한 곳이었어요. 선잠단이 점점 잊혀가자, 비단과 누에를 수호하는 선잠해치가 깨어났습니다. 그는 흩어진 제단 돌을 찾고 박물관의 기록을 지키며, 성북구의 역사와 예술을 다시 사람들에게 알렸어요. 성북동 문화재 거리에서 한복 패션쇼를 열게 만든 것도 바로 선잠해치의 마법이었답니다.",
    ...
    "강북구": {
        ...
        "story": "북한산 깊은 곳, 노래하는 바위가 사라지자 산의 균형이 깨졌어요. 그때 잠자던 북수해치가 '크르르르!' 하며 깨어났죠. 그는 소용돌이치며 바위를 훔쳐 간 악당들을 물리치고 다시 산의 평화를 되찾았어요. 등산객들이 산에서 듣는 '쿵... 쿵...' 발자국 소리는 북수해치가 산을 순찰하는 소리랍니다. 그는 오늘도 말없이 북한산을 지키고 있습니다.",
    ...
    "도봉구": {
        ...
        "story": "도봉구의 '평화문화진지'는 과거 군사 시설이었지만, 호랑해치의 마법으로 예술 공간이 되었어요. 호랑해치는 사람들 사이의 다툼이 일어날 때마다 붓을 휘둘러 그들의 마음에 평화의 그림을 그려줍니다. 탱크가 있던 자리에 꽃을 심고, 경계가 있던 곳에 다리를 놓았죠. 그의 꼬리는 붓으로 되어 있어서 언제든 평화의 메시지를 그릴 수 있답니다.",
