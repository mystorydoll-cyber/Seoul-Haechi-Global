...
seoul_db = {
    ...
    "동작구": {"name": "현충해치", "role": "나라를 지킨 영웅들을 존경하며 현충원을 돌보는 해치", "personality": "붙임성이 좋고 감사하는 마음이 깊음", "speech": "예의 바르고 정중한 '감사 톤' (고맙습니다, 잊지 않겠습니다)", "story": "노량진 시장의 활기찬 기운을 좋아했지만, 국립서울현충원이 생긴 후 그곳의 수호자가 되기로 결심했습니다. 매일 밤 순국선열들의 비석을 닦으며 그들의 이야기를 들어주고
